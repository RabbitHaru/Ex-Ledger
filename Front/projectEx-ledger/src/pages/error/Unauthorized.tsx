    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full text-center space-y-12 relative z-10">
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-10 duration-700">
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-40 h-40 bg-slate-900 rounded-[56px] rotate-6 flex items-center justify-center shadow-2xl">
                <Lock size={80} className="text-white -rotate-6" />
              </div>
              <div className="absolute -right-4 -bottom-4 w-20 h-20 bg-indigo-500 rounded-3xl flex items-center justify-center text-white shadow-xl animate-pulse">
                <ShieldAlert size={40} />
              </div>
            </div>
          </div>
          <h1 className="text-[140px] font-black text-slate-100 leading-none tracking-tighter select-none">403</h1>
        </div>

        {/* 메시지 영역 */}
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-200">
          <h2 className="text-4xl font-black text-slate-900 tracking-tight">접근 권한이 없습니다.</h2>
          <p className="text-slate-500 font-bold text-lg leading-relaxed max-w-lg mx-auto">
            이 페이지에 접근할 수 있는 권한이 부족합니다. <br />
            관리자에게 문의하시거나 권한이 있는 계정으로 다시 로그인해 주세요.
          </p>
        </div>
        ...
        <div className="pt-12 text-slate-300 font-bold text-sm tracking-widest uppercase animate-in fade-in duration-1000 delay-700">
          © 2026 Ex-Ledger Team. Security is our priority.
        </div>
      </div>
    </div>
  );
